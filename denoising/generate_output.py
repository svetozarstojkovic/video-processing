...
def generate_output(video_path, factor, file_name):
    ...
    np.save('output/' + file_name, input_array)
    np.save('output/' + file_name + '_test', test_input_array)


generate_output(video_path=new_girl_location, factor=28, file_name='output_convolutional')
